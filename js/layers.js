addLayer("p", {
    ...
    baseResource: "MW", // Name of resource prestige is based on
    ...
    upgrades:{
        11:{
            title:"There Wood On These Leaves!",
            description:"Double your Leaves gain.",
            cost: new Decimal(2),
        },
        12:{
            title:"Upgrade 2!",
            description:"Bonus to MW based on current leaves.",
            cost: new Decimal(4),
            effect() {
